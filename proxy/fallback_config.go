...
// fallbackNetworkConfig is inlined from tonutils-storage/config/fallback.go
// to avoid pulling adnl-tunnel (GPL-3.0) into the module graph.
const fallbackNetworkConfig = `{
  "@type": "config.global",
  "dht": {
